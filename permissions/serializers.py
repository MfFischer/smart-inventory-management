...
class PermissionSchema(Schema):
    ...
    """
    id = fields.Int(dump_only=True)  # Only serialize the ID, don't require it in input data.
    name = fields.Str(
        required=True,
    ...
    def validate_name(self, value):
        ...
        Raises:
            ValidationError: If the permission name already exists in the database.
        """
